...
class ArraysTest < Minitest::Test
  ...
  def test_3
    ...
    hummus = hummus.length
    assert_equal 3, hummus
  end
  ...
  def test_4
    ...
    world_cup << "Brazil" #could have used array += ["Brazil", "Argentina"]
  ...
  def test_a
    ...
    last_element = world_cup.slice!(-1) #could have used .pop also
